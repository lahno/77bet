...
--
-- Хост: 127.0.0.1:3306
-- Время создания: Июн 04 2018 г., 16:20
...
INSERT INTO `games` (`id`, `competition`, `title`, `date`, `img`, `link`, `created_at`, `updated_at`) VALUES
(1, 'Соревнование 1', 'Заголовок сор1', '2018-06-19', '/thumb/items/5b14ec7f6a0ffWallpapers (1).png', NULL, '2018-06-04 07:38:39', '2018-06-04 07:38:39');
...
(14, '2018_05_23_213614_create_settings_table', 2),
(17, '2018_05_30_103749_create_games_table', 3),
(18, '2018_06_04_103035_add_vievs_to_settings_table', 3),
(19, '2018_06_04_152031_add_to_uesrs_table', 4);
...
(1, 'Test1', 'ярлык1', '2018-07-19 00:00:00', 1.7, 95, 1500, 'body', '2018-05-23 16:40:58', '2018-06-04 07:55:42'),
(2, 'Test2', 'ярлык2', '2018-07-19 03:00:00', 1.5, 98, 500, 'body2', '2018-05-23 16:42:50', '2018-06-04 07:55:50'),
(3, 'Test3', 'ярлык3', '2018-07-27 06:00:00', 1.3, 98, 800, 'body3', '2018-05-23 16:43:13', '2018-06-04 07:55:57');
...
CREATE TABLE `settings` (
  `id` int(10) UNSIGNED NOT NULL,
  `view_block_games` tinyint(1) NOT NULL DEFAULT '0',
  ...
  `graph_num_1` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `graph_num_2` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `block_1_1` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `block_1_2` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `block_1_3` varchar(25) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
ROW_FORMAT=DYNAMIC;
...
INSERT INTO `settings` (`id`, `view_block_games`, `telegram_link`, `fb_link`, `vk_link`, `instagram_link`, `phone`, `graph`, `graph_num_1`, `graph_num_2`, `block_1_1`, `block_1_2`, `block_1_3`, `created_at`, `updated_at`) VALUES
(1, 0, 'Telegram link', 'Facebook link', 'VK link', 'Instagram link', '+7 (999)967-62-21', '0, 7, 14, 21, 31', '89', '+58  -6', '98', '20000', '1500', NULL, '2018-06-04 07:56:24');
...
(1, 'lahno.dima@gmail.com', 1, '180523074613_1', 1500, 'paid', NULL, NULL, '2018-05-23 16:46:13', '2018-05-23 16:46:13'),
(2, 'lahno.dima@gmail.com', 1, '180523090901_1', 1400, 'created', NULL, NULL, '2018-05-23 18:09:01', '2018-05-23 18:09:01'),
(3, 'lahno.dima@gmail.com', 1, '180523090959_1', 1400, 'paid', NULL, NULL, '2018-05-23 18:09:59', '2018-05-23 18:09:59'),
...
INSERT INTO `users` (`id`, `name`, `email`, `phone`, `adm`, `password`, `provider`, `provider_id`, `remember_token`, `created_at`, `updated_at`) VALUES
(1, 'Дмитрий Лахно', 'lahno.dima@gmail.com', '932277199', 1, '$2y$10$vhZG4BlQIeRTbajk.rKG8uqp9qydwXoeeYTzUHUSk.RB2JgG04UOa', NULL, NULL, NULL, '2018-05-23 16:39:52', '2018-05-23 16:39:52');
